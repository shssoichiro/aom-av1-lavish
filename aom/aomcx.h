...
enum aome_enc_control_id {
  ...
  AOME_SET_BUTTERAUGLI_RDO_BSIZE = AOME_SET_DELTA_QINDEX_MULT + 9,

  AOME_SET_BUTTERAUGLI_RESIZE_FACTOR = AOME_SET_DELTA_QINDEX_MULT + 10,
...
typedef enum {
  ...
  AOM_TUNE_OMNI = 12,
  AOM_TUNE_IMAGE_PERCEPTUAL_QUALITY = 13,
  AOM_TUNE_IMAGE_PERCEPTUAL_QUALITY_VMAF_PSY_QP = 14,
  AOM_TUNE_FAST_VMAF_PSY_QP = 15,
} aom_tune_metric;
...
AOM_CTRL_USE_TYPE(AOME_SET_BUTTERAUGLI_RDO_BSIZE, unsigned int)
#define AOM_CTRL_AOME_SET_BUTTERAUGLI_RDO_BSIZE
