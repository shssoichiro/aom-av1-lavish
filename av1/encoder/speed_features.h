...
typedef enum {
  ...
  CDEF_FULL_SEARCH_Q1,  // Psy versions of reduced CDEF strength search space
                        // based on quantizer Applies to full and L1 currently,
                        // used for quality and speed pruning
  CDEF_FULL_SEARCH_Q2,
  CDEF_FULL_SEARCH_Q3,
  CDEF_FULL_SEARCH_Q4,
  CDEF_FULL_SEARCH_Q5,
